...
if ~isempty(tree.kids)
    for i = 1:length(tree.kids)
        kid = tree.kids{i};
        line([tree.X kid.X], [tree.Y kid.Y],'MarkerEdgeColor','g',...
    'MarkerFaceColor',[0.5,0.5,0.5]);
    end
    line(tree.X, tree.Y, 'marker', 'h', 'markersize', 6,'MarkerEdgeColor','g',...
    'MarkerFaceColor',[0.5,0.5,0.5])
    opText = tree.op;
...
%     opText = tree.op; 
    line(tree.X, tree.Y, 'marker', '.', 'markersize', 8,'MarkerEdgeColor','g',...
    'MarkerFaceColor',[0.5,0.5,0.5])
